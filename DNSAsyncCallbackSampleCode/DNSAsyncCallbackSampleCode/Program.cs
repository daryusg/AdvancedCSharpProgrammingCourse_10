/*
 * Part 8 - Delegates - Asynchronous Method Calls
 * 
The following example demonstrates using asynchronous methods to
get Domain Name System information for the specified host computer.

Code copied from: https://learn.microsoft.com/en-us/dotnet/standard/asynchronous-programming-patterns/using-an-asynccallback-delegate-and-state-object
ToDo look into: https://www.cloudflare.com/learning/dns/what-is-dns/

Collapse all methods (show only method signatures)
Press:
Ctrl + M, Ctrl + O
To expand everything again:
Ctrl + M, Ctrl + L
*/
