...
{
    /*
     * Part 16 - Generics - The Factory Design Pattern
     * 
    https://learn.microsoft.com/en-us/dotnet/framework/tools/ildasm-exe-il-disassembler
    c:\Users\kev\source\repos\AdvancedCSharpProgrammingCourse_10\DigitalProductInventoryApplication\DigitalProductInventoryApplication\bin\Debug\net10.0>_
        ildasm DigitalProductInventoryApplication.dll /output:DigitalProductInventoryApplication.il
    ...
    */
    public class Program
    {
        ...
        {
            //https://github.com/GavinLonDigital/DigitalProductInventoryApplication/blob/master/DigitalProductInventoryApplication/Program.cs
    ...
    public  class ProductBase : IPrimaryProperties
    {
    ...
    public static class FactoryPattern<T, U> where T : class, U, new() //note: when used with other constraints, the new() constraint must be specified last.
                                                  where U : class, IPrimaryProperties //note: in this example, the U's class constraint is redundant
    {
        public static U GetInstance()
        {
            U objT;
            objT = new T(); //note: //, new() errors this line
            return objT;
        }
    }
}